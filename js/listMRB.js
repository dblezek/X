...
*/
var MRMLItem = React.createClass({displayName: 'MRMLItem',
  ...
  render: function () {
    ...
    return (
      React.createElement("tr", {className: "MRMLItem"}, 
      React.createElement("td", null, 
        React.createElement("a", {href: this.state.mrbURL}, 
          React.createElement("img", {src: "http://slicer.kitware.com/midas3/item/thumbnail?itemId=" + this.props.data.item_id + "&token=" + this.props.token, width: "64"})
        )
      ), 
        React.createElement("td", null, 
...
var MRMLList = React.createClass({displayName: 'MRMLList',
  getInitialState: function() {
  ...
  render: function () {
    ...
    this.props.items.forEach(function(item) {
      rows.push(React.createElement(MRMLItem, {key: item.item_id, data: item, token: token}));
    });

    return (
      React.createElement("div", {className: "MRMLList"}, 
...
.done(function(data){
  ...
  React.render(  // Render HelloMessage component at #name.
    ...
    React.createElement(MRMLList, {items: items})
    ),
